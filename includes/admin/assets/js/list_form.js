...
function fun_update_message_state_by_id(id) {
  jQuery(function ($) {
    data = {
      action: "update_message_state_SEXTOHafez",
      type: "POST",
      nonce: ajax_object_efm_core.nonce,
      id: id
    };
...
function fun_get_messages_by_id(id) {
  ...
  jQuery(function ($) {
    data = {
      action: "get_messages_id_SEXTOHafez",
      nonce: ajax_object_efm_core.nonce,
      type: "POST",
...
function fun_emsFormBuilder_get_all_response_by_id(id) {
  ...
  jQuery(function ($) {
    data = {
      action: "get_all_response_id_SEXTOHafez",
      nonce: ajax_object_efm_core.nonce,
      type: "POST",
      id: id
    };
    $.post(ajax_object_efm.ajax_url, data, function (res) {
      ...
      if (res.success == true) {
        ...
        // localStorage.setItem('valueJson_ws_messages',JSON.stringify(valueJson_ws_messages) );
        //console.l(`get_all_response_id_SEXTOHafez`,res);
...
function fun_send_replayMessage_ajax_emsFormBuilder(message, id) {
  ...
  jQuery(function ($) {
    data = {
      action: "set_replyMessage_id_SEXTOHafez",
      type: "POST",
      nonce: ajax_object_efm_core.nonce,
      id: id,
...
function fun_show_help__emsFormBuilder() {
  ...
  let str = "";
  for (const l in listOfHow_SEXTOHafez) {
    //console.l(l);
    str += `

    <a class="btn efb btn-darkb text-white btn-lg d-block mx-3 mt-2" href="${listOfHow_SEXTOHafez[l].url}">
        <i class="efb bi-youtube mx-1"></i>${listOfHow_SEXTOHafez[l].title}
   </a>
...
function fun_find_track_emsFormBuilder() {
  ...
  if (el.length < -1) {
    ...
    jQuery(function ($) {
      ...
      //console.l('get_track_id_SEXTOHafez');  
      data = {
        action: "get_track_id_SEXTOHafez",
        nonce: ajax_object_efm_core.nonce,
        value: el,
      };
...
function clear_garbeg_emsFormBuilder() {
  ...
  jQuery(function ($) {
    ...
    data = {
      action: "clear_garbeg_SEXTOHafez",
      nonce: ajax_object_efm_core.nonce
    };
