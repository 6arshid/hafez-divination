 ...
 */
		/* 	$lang = get_locale();
			...
			<div class="top_circle-efb-1"></div>
				<nav class="navbar navbar-expand-lg navbar-light efb" id="navbar">
					<div class="container">
						<a class="navbar-brand efb" href="admin.php?page=SEXTOHafez_create" >
						
						
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav me-auto mb-2 mb-lg-0">
								<li class="nav-item"><a class="nav-link efb active" aria-current="page" onClick="fun_show_content_page_emsFormBuilder('forms')" role="button"><?php _e('Forms','SEXTOHafez') ?></a></li>
								<li class="nav-item">
									<a class="nav-link efb" onClick="fun_show_content_page_emsFormBuilder('setting')" role="button"><?php _e('Setting','SEXTOHafez') ?></a>
								</li>
								<li class="nav-item">
									<a class="nav-link efb" href="admin.php?page=SEXTOHafez_create" role="button"><?php _e('Create','SEXTOHafez') ?></a>
								</li>
								<li class="nav-item">
									<a class="nav-link efb" onClick="fun_show_content_page_emsFormBuilder('help')" role="button"><?php _e('Help','SEXTOHafez') ?></a>
								</li>
							</ul>
							<div class="d-flex">
								<form class="d-flex">
									<i class="efb bi-search search-icon"></i>
									<input class="form-control efb search-form-control efb-rounded efb me-2" type="search" type="search" id="track_code_emsFormBuilder" placeholder="<?php _e('Enter the Confirmation Code','SEXTOHafez') ?>">
									<button class="btn efb btn-outline-pink me-2" type="submit" id="track_code_btn_emsFormBuilder" onClick="fun_find_track_emsFormBuilder()"><?php _e('Search','SEXTOHafez') ?></button>
								</form>
				...
				<div id="alert_efb" class="mx-5"></div>
					...
					<div class="row" id ="content-efb">
				 	<div class="card-body text-center my-5"><div class="lds-hourglass"></div> <h3 class="efb"><?php _e('Loading','SEXTOHafez') ?></h3></div>
		...
		/* 	wp_register_script('SEXTOHafez-list_form-js', SEXTOHafez_PLUGIN_URL . 'includes/admin/assets/js/list_form.js', null, null, true);
			wp_enqueue_script('SEXTOHafez-list_form-js');
			wp_localize_script( 'SEXTOHafez-list_form-js', 'ajax_object_efm',
				array( 'ajax_url' => admin_url( 'admin-ajax.php' ),			
					...
					'poster'=> SEXTOHafez_PLUGIN_URL . 'public/assets/images/efb-poster.svg',
					'pro'=>$pro
	...
	public function get_not_read_response(){
		$table_name_msg = $this->db->prefix . "SEXTOHafez_msg_";
		$table_name_rsp = $this->db->prefix . "SEXTOHafez_rsp_"; 
